...
{
    node** arr = (node**)malloc(sizeof(node*));
    *(arr) = create_node(0, "empty", "NULL", 0, NULL);
    $$ = create_node(0, "ExtDefList", "NULL", 1, arr);
}
;
...
| /* empty */ 
{
    node** arr = (node**)malloc(sizeof(node*));
    *(arr) = create_node(0, "empty", "NULL", 0, NULL);
    $$ = create_node(0, "OptTag", "NULL", 1, arr);
}
;
Tag : ID 
{
...
| /* empty */ 
{
    node** arr = (node**)malloc(sizeof(node*));
    *(arr) = create_node(0, "empty", "NULL", 0, NULL);
    $$ = create_node(0, "StmtList", "NULL", 1, arr);
}
;
Stmt : Exp SEMI 
{
...
| /* empty */ 
{
    node** arr = (node**)malloc(sizeof(node*));
    *(arr) = create_node(0, "empty", "NULL", 0, NULL);
    $$ = create_node(0, "DefList", "NULL", 1, arr);
}
;
